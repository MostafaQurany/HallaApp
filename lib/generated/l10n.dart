...
class S {
  ...
  String get pleaseEnterVerificationCodeNsentToYourPhoneNumber {
    return Intl.message(
      'Please enter verification code \n Sent to your phone number.',
      name: 'pleaseEnterVerificationCodeNsentToYourPhoneNumber',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Personal \nInformation`
  String get personalNinformation {
    return Intl.message(
      'Personal \nInformation',
      name: 'personalNinformation',
      desc: '',
      args: [],
    );
  }
