...
class __$$LoadedImplCopyWithImpl<T, $Res>
    extends _$AiStateCopyWithImpl<T, $Res, _$LoadedImpl<T>>
...
class _$LoadedImpl<T> implements Loaded<T> {
  ...
  @override
  String toString() {
    return 'AiState<$T>.loaded(data: $data)';
  }
...
abstract class Loaded<T> implements AiState<T> {
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'AiState<$T>.error(message: $message)';
  }
