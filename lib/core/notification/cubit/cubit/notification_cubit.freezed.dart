...
mixin _$NotificationState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<MyNotification> notifications, bool hasMore)
        loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<MyNotification> notifications, bool hasMore)? loaded,
...
abstract class _Loading<T> implements NotificationState<T> {
...
abstract class _Success<T> implements NotificationState<T> {
...
abstract class _$$LoadedImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({List<MyNotification> notifications, bool hasMore});
}

/// @nodoc
class __$$LoadedImplCopyWithImpl<T, $Res>
    extends _$NotificationStateCopyWithImpl<T, $Res, _$LoadedImpl<T>>
...
class _$LoadedImpl<T> implements _Loaded<T> {
  const _$LoadedImpl(
      {required final List<MyNotification> notifications,
  ...
  @override
  String toString() {
    return 'NotificationState<$T>.loaded(notifications: $notifications, hasMore: $hasMore)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_notifications), hasMore);
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(notifications, hasMore);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(notifications, hasMore);
  }
...
abstract class _Loaded<T> implements NotificationState<T> {
  const factory _Loaded(
      {required final List<MyNotification> notifications,
      required final bool hasMore}) = _$LoadedImpl<T>;
...
class _$ErrorImpl<T> implements _Error<T> {
  ...
  @override
  String toString() {
    return 'NotificationState<$T>.error(message: $message)';
  }
...
abstract class _Error<T> implements NotificationState<T> {
