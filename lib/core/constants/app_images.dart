class AppImages {
  ...
  static String pinCodeLottie = _lottieName("pin_code_.json");
  static String nfcLoginLottie = _lottieName("nfc_login.json");
  static String welcomePinCodeLottie = _lottieName("welcome_pin_code.json");
